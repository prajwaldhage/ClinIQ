...
const MOCK_USERS = [
  {
    ...
    email: "arjun.sharma@nexusmd.app",
  ...
  },
  {
    ...
    email: "rajesh.gupta@nexusmd.app",
    role: "doctor" as const,
  ...
  },
  {
    id: "u9",
    name: "Dr. Meera Nair",
    email: "meera.nair@nexusmd.app",
    role: "research" as const,
    department: "Clinical Research",
    status: "active" as const,
    last_active: "4 hr ago",
    consultations: 0,
    joined: "Jul 2024",
  },
  {
    ...
    try {
      ...
      if (data.users?.length > 0) {
        const mapped = data.users.map((u: Record<string, unknown>) => ({
          ...
          status: (u.is_active !== false ? "active" : "inactive") as
            | "active"
            | "inactive",
          last_active: u.updated_at
            ? new Date(u.updated_at as string).toLocaleDateString()
            : "Unknown",
          consultations: 0,
          joined: new Date(u.created_at as string).toLocaleDateString("en-IN", {
            month: "short",
            year: "numeric",
          }),
        }));
            ...
            <Card className="border-blue-500/30">
              ...
              <CardContent>
                <div className="grid grid-cols-4 gap-3">
                  <div>
                    <label className="text-[10px] text-[var(--foreground-subtle)] uppercase">
                      Full Name
                    </label>
                    <input
                      value={newUser.name}
          ...
          {filtered.map((u, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`inline-flex items-center gap-1 text-[10px] font-medium ${roleCfg.color}`}
                >
                ...
                <span className="text-xs text-[var(--foreground)]">
                  {u.consultations > 0 ? u.consultations : "—"}
                </span>
                <span
