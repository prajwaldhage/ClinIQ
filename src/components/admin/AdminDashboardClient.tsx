      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-[var(--text-secondary)] mt-1">
            System health, user activity, and compliance
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          return (
            ...
            >
              <Card
                className="bg-[var(--surface)] border-[var(--border)] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
        ...
        >
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[var(--text-primary)]">
              ...
              System Health
              <Badge className="ml-auto text-[9px] bg-[#10B981]/10 text-[#10B981] border-0">
                All Operational
              </Badge>
            </CardTitle>
          </CardHeader>
            ...
            {MOCK_SYSTEM_HEALTH.map((service, i) => (
              ...
              >
                ...
                <Progress
                  ...
                  className="w-16 h-1.5 bg-[var(--border)]"
        ...
        >
          ...
          <CardContent className="space-y-2">
            {[
              ...
              {
                event: "Safety alert acknowledged",
                actor: "Dr. Patel",
                time: "8m ago",
              },
              {
                event: "ICD codes mapped (E11.9, I10)",
                actor: "System",
                time: "12m ago",
              },
              {
                event: "Patient summary sent via WhatsApp",
                actor: "System",
                time: "15m ago",
              },
              {
                event: "Consent recorded for P. Kumar",
                actor: "Dr. Sharma",
                time: "22m ago",
              },
            ].map((event, i) => (
