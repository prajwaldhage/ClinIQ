...
export function FlashbackCard({
  ...
  const visit: FlashbackVisit =
    MOCK_FLASHBACKS[consultationId ?? "default"] ?? MOCK_FLASHBACKS["default"];
        ...
        >
          ...
          <div className="flex flex-wrap gap-1.5">
            {visit.diagnosis.map((d) => (
              <div
                key={d}
                className="flex items-center gap-1 px-1.5 py-0.5 rounded-md border border-[var(--border)] bg-[var(--background)]/50"
              >
            ...
            {visit.medications.map((m) => (
              <div
                key={m}
                className="flex items-center gap-1 px-1.5 py-0.5 rounded-md border border-green-500/25 bg-green-500/5"
              >
